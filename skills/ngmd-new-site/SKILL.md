...
| `vite.config.ts`                  | AnalogJS config plus the six NgMd build plugins (externalLinkGuard, internalLinkGuard, pageMetaPlugin, sitemapPlugin, rawMdPlugin, searchIndexPlugin).                                                                                                                                                                                                                             |
