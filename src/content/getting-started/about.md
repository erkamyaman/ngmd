...
<ngmd-card-grid columns="2">
  ...
  <ngmd-card icon="lightbulb" title="Santosh Yadav" link="https://github.com/santoshyadavdev">
    The spark came from his 2023 <a href="https://github.com/analogjs/analog/discussions/779" target="_blank" rel="noopener noreferrer">AnalogJS discussion</a>, which named the gap NgMd was built to fill.
  </ngmd-card>
</ngmd-card-grid>
...
## License <ngmd-badge variant="stable">MIT</ngmd-badge>
