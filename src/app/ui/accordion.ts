...
@Component({
  ...
  template: `
    ...
    >
      <summary
        class="flex items-center justify-between gap-3 cursor-pointer list-none px-5 py-3 text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-900 select-none"
      >
        <span>{{ title() }}</span>
        <span
      ...
      <div
        class="px-5 pt-1 pb-4 text-sm text-zinc-700 dark:text-zinc-300 [&>*:first-child]:mt-0 [&>*:last-child]:mb-0"
      >
